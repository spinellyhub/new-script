...
-- Tabla para guardar estados persistentes de toggles
...
-- Animar solo al abrir menu principal
...
miniBtn.MouseButton1Click:Connect(function()
	...
	if subMenuAbierto then
		subMenuAbierto.Visible = true
	end
end)

-- ====== FUNCION CREAR INTERRUPTOR ======
...
local opcionesLaser = {
	{nombre="Laser Lagger", callback=function(state) print("Laser Lagger:",state) end}
}
local opcionesZZZ = {
	{nombre="ZZZ Mode", callback=function(state) print("ZZZ Mode:",state) end}
}
...
discordBtn.Image = "rbxassetid://9069883411" -- reemplaza si no funciona
