...
local tituloAnimadoEjecutado = false
...
-- Ejecutar título animado solo la primera vez que se abre el menú
animarTitulo()
tituloAnimadoEjecutado = true
...
-- =====================
-- Tabla de estados de toggles
-- =====================
local estadosInterruptores = {}

-- =====================
-- Función crear interruptor persistente
-- =====================
local function crearInterruptor(parent, y, nombre, callback)
    ...
    local function cambiarEstado()
        estado = not estado
        estadosInterruptores[nombre] = estado -- persistente
        actualizar()
        callback(estado)
    end
